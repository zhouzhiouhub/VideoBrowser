...
class ScriptLoader(
    ...
    companion object {
        ...
        const val GENERIC_AD_OVERLAY_DETECTOR_SCRIPT_ASSET = "scripts/generic_ad_overlay_detector.js"
        ...
        const val VIDEO_CONTROL_COORDINATOR_SCRIPT_ASSET = "scripts/video_control_coordinator.js"
        ...
        val COMMON_SCRIPT_ASSETS = listOf(
            ...
            GENERIC_AD_OVERLAY_DETECTOR_SCRIPT_ASSET,
            ...
            VIDEO_CONTROL_COORDINATOR_SCRIPT_ASSET,
